angular.module('appController').controller('indexController', function($scope){
    ...
    function ShowMouseCoordinates(x, y) {
        document.getElementById("MouseCoords").innerHTML="Coordenadas do MOUSE: (" + x + "," + y + ") " +
    ...
    function ShowReferencialROICoordinates() {
        document.getElementById("ROICoordsRef").innerHTML="Coordenadas Referenciais da ROI: (" +
    ...
    function ShowAbsoluteROICoordinates() {
        ...
        //adjust coordinates
        document.getElementById("ROICoordsAbs").innerHTML="Coordenadas Absolutas da ROI: ("
